...
Errors:
    400 EMPTY_COMMENT "Comment content cannot be empty."
    401 UNAUTHORIZED "Authentication required to post comments."
    404 POST_NOT_FOUND "The requested post does not exist or is no longer accepting comments."